          ...
          <div class="row align-items-center site-hero-inner justify-content-center">
            <div class="col-md-12 text-center">
              ...
              <div class="mb-5 element-animate">
                <h1>{{__('ui.ourromms')}}</h1>
                <p>{{__('ui.discoverourrooms')}}</p>
              </div>
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="media d-block room mb-0">
                <figure>
                  <img src="/imgblade/img_2.jpg" alt="Generic placeholder image" class="img-fluid">
                ...
                <div class="media-body">
                  ...
                  <div class="d-flex justify-content-between">
                    <p><a href="{{ route('camera1') }}" class="btn btn-primary btn-sm">Dettagli</a></p>
                    <p><a href="{{ route('camera1') }}" class="btn btn-primary btn-sm">Prenota</a></p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 mb-4">
              <div class="media d-block room mb-0">
                <figure>
                  <img src="/imgblade/img_3.jpg" alt="Generic placeholder image" class="img-fluid">
                  <div class="overlap-text">
                    <span>
                      Featured Room
                      <span class="ion-ios-star"></span>
